...
const SYSTEMS = [
  { id: "PROP", label: "ENGINE", duration: 600 },
  { id: "AVNX", label: "FUEL", duration: 500 },
  { id: "STRCT", label: "TYRES", duration: 700 },
  { id: "TLMTR", label: "BODY", duration: 400 },
  { id: "PAYLD", label: "AERODYNAMICS", duration: 550 },
  { id: "IGNIT", label: "LOOKS", duration: 800 },
];
      ...
      >
        ...
        <div style={{ marginBottom: 28, borderBottom: "1px solid #0D1A30", paddingBottom: 20 }}>
          <div className="loader-title" style={{ marginBottom: 8 }}>
            CAR CONFIGURATOR ∙ COLD START
          </div>
          <div className="main-title">BUILD CHECK</div>
          <div
            style={{
              marginTop: 6,
